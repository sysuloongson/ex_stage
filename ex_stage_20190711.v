...
always @(*) begin
           if(FU_ctrl) begin
           alu_dest_addr[`DestAddr_way0]= (FU_en[`FUen_DIV] == `ENABLE)? 5'b0:is_Dest_out[`DestAddr_way0];
           alu_dest_addr[`DestAddr_way1]= (FU_en[`FUen_MUL] == `ENABLE)? 5'b0:is_Dest_out[`DestAddr_way1];
           end
           else begin
           alu_dest_addr[`DestAddr_way0]= (FU_en[`FUen_MUL] == `ENABLE)? 5'b0:is_Dest_out[`DestAddr_way0];
           alu_dest_addr[`DestAddr_way1]= (FU_en[`FUen_DIV] == `ENABLE)? 5'b0:is_Dest_out[`DestAddr_way1];
           end
end
 ...
 always @(*) begin
			...
			else if (ALU0_op == `INSN_ERET) begin
